...
const float MIN_SIGNAL_RATE = 5.0;  // Example threshold in MCPS //THANKS TO THIS I WONT GET PHANTOM READINGS, IF I FILTER THE READINGS WITH THIS //if 10, it wont see my legs that well, while stanging on the road. 
