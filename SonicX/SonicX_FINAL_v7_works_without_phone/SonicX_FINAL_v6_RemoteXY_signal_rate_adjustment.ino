...
float middle_signal_rate =0;
float signal_rate_minimal=0;
...
//Initial RemoteXY GUI values
  ...
  RemoteXY.signal_rate_minimal =5;
  
  //ONLY FOR IT TO WORK WITHOUT PHONE.
  RemoteXY.Start_switch= true; //ONLY FOR IT TO WORK WITHOUT PHONE.
  //ONLY FOR IT TO WORK WITHOUT PHONE.
}
...
//RemoteXY varibles -> global variables
  ...
  signal_rate_minimal = RemoteXY.signal_rate_minimal;
...
//RemoteXY GUI indicators
  ...
  RemoteXY.signal_rate_graph = middle_signal_rate;
