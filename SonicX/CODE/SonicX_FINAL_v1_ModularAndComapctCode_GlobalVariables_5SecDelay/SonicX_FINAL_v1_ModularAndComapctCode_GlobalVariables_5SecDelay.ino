...
//if MAIN_SWITCH ON
  ...
  // If 5 seconds have passed since the switch was turned on
    if (millis() - startMillis >= 5000) {
      // After the 5-second delay, check for manual or automatic mode
    //if MANUAL_MODE
...
//
  RemoteXY_delay(50); //can be even smaller number?? ok for sensors on 70cm? 10m worked also //DO I EVEN NEED THIS DELAY? worked with it commented out?
} 
