...
//debug serial + plotter
  ...
  //sendColorDataToSerial(detectedColor, red, green); //while dealing with basic driving autonomous part
//
...
//if MAIN_SWITCH ON
  ...
  // If 5 seconds have passed since the switch was turned on
    if (millis() - startMillis >= 2000) { //should be 5000 for 5 sec
